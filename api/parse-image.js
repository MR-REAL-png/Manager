...
// Jeda antar percobaan (ms): percobaan ke-1 gagal → tunggu 1.5s, ke-2 → 3s
...
function getApiKeys() {
  ...
  // Fallback: jika pakai nama lama GEMINI_API_KEY
...
export default async function handler(req, res) {
  ...
  const { imageBase64, mimeType, categories = [], banks = [] } = req.body || {};
